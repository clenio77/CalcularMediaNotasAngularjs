...
.controller("indexController",function($scope){
	$scope.titulo = "Home";
	$scope.alunos = [
		{nome: "Camila",email:"camila@mail.com",nota1:65,trabalho1: 50, nota2:80,nota3:55},
        ...
        {nome: "Paulo",email:"paulo@mail.com",nota1:60,nota2:50,nota3:55},
        {nome: "Mariana",email:"mariana@mail.com",nota1:65,nota2:80,nota3:59}
	];
	...
	var media = function(Aluno){
		console.log(contar2++);
		var media = (parseFloat(Aluno.nota1) + parseFloat(Aluno.trabalho1) + parseFloat(Aluno.nota2) + parseFloat(Aluno.nota3))/4;
	...
	$scope.salvarAluno = function(Aluno){
		...
		alunoEditar.trabalho1 = Aluno.trabalho1;
	...
	var limpaForm = function(){
		$scope.Aluno = {nome: "",email:"",nota1:'',trabalho1:'',nota2:'',nota3:'',media:''};
	};
